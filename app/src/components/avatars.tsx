...
const Avatars = () => {
  return (
    <div className='flex -space-x-2 '>
      <img loading="lazy" className="inline-block h-10 w-10 md:h-14 md:w-14 ring-2 ring-white object-cover rounded-full hover:scale-110 transition transform duration-100 hover:shadow-md" src={personOne} alt="person 1" />
