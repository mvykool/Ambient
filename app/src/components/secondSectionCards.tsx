    ...
    <div className="flex flex-col md:flex-row gap-5 justify-center items-center w-full my-16 md:my-28">
      ...
      >
        <img
          src={cardOne}
          loading="lazy"
          className="absolute object-cover rounded-xl h-full w-full -z-10"
          alt="cardone"
        />
      ...
      >
        ...
        <h3 className="text-normal mt-5 font-semibold md:mt-20 md:text-2xl z-40 text-center ">
          Join us in sculpting <br /> a green and sustainable world
        </h3>
        <button className="mt-6 md:mt-10 rounded-xl bg-white border border-black z-40 px-3 md:px-5 py-2 md:py-3 text-sm md:text-normal hover:scale-110 transform transition hover:shadow-lg">
          Get Started
        </button>
        {/* falling pills*/}
        <div className="button px-4 py-2 text-sm bg-green-200 absolute rounded-2xl top-0 opacity-50">
          Ethics
        </div>
        <div className="button px-4 py-2 text-sm bg-green-200 absolute rounded-2xl top-0 opacity-50">
          Eco-friendly
        ...
        <div className="button px-4 py-2 text-sm bg-accent absolute rounded-2xl top-0 opacity-50">
          Progressive
        </div>
        <div className="button px-4 py-2 text-sm bg-accent absolute rounded-2xl top-0 opacity-50">
          Thoughtful
